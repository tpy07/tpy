...
<div id="wrap">
    ...
    <div class="header">
        ...
        <div id="menu">
            <ul>
                ...
                <li class="selected"><a href="../user/reg.action">注册</a></li>
            </ul>
        </div>
    ...
    <div class="center_content">
        <div class="left_content">
            <div class="title"><span class="title_icon"><img src="../style/images/bullet1.gif" alt="" title="" /></span>注册</div>

            <div class="feat_prod_box_details">
                <div class="contact_form">
                    <div class="form_subtitle">建立新账户</div>
                        <div class="form_row">
                       ...
                       <%-- <div class="form_row">
                        ...
                        <div class="form_row">
                            <input type="button" onclick="addUser()" class="register" value="注册" />
                        </div>
                </div>
